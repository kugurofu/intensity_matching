...
class ObsBayesMap(Node):
    ...
    def pointcloud2_to_xyz(self, msg):
        pts = np.frombuffer(msg.data, dtype=np.uint8).reshape(-1, msg.point_step)
    ...
    def publish_map(self, msg):
        ...
        x, y = self.pointcloud2_to_xyz(msg)
        ...
        static_mask = prob > 0.7 # static obs map
        dynamic_mask = prob < 0.3 # dynamic obs map
